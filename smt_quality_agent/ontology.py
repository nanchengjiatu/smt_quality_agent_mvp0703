...
CONCEPTS = [
    ...
    OntologyConcept(
        ...
        {"element": "element.stencil_aperture", "stage": "stage.release",
         ...
         "signature": "avdp:down,aadp:down|flat,ahdp:down",
         "signature_text": "体积↓ 面积↓/平 高度↓",
    ...
    OntologyConcept(
        ...
        {"element": "element.stencil_aperture", "stage": "stage.release",
         ...
         "signature": "avdp:down,aadp:flat,ahdp:any",
         "signature_text": "体积↓ 面积平 高度不稳",
         "typical_spatial": ["spatial.single_pad", "spatial.local_area"],
    ...
    OntologyConcept(
        ...
        {"element": "element.stencil_underside", "stage": "stage.cleaning_cycle",
         ...
         "signature": "avdp:up,aadp:up,ahdp:flat|down",
         "signature_text": "体积↑ 面积↑ 高度平/↓",
    ...
    OntologyConcept(
        ...
        {"element": "element.board_support", "stage": "stage.print_stroke",
         ...
         "signature": "avdp:up|flat,aadp:up,ahdp:down",
         "signature_text": "面积↑ 高度↓",
    ...
    OntologyConcept(
        ...
        {"element": "material.solder_paste", "stage": "stage.release",
         "direction": "多锡", "onset": "gradual",
         "signature": "avdp:flat,aadp:up,ahdp:down",
         "signature_text": "体积平 面积↑ 高度↓",
    ...
    OntologyConcept(
        ...
        {"element": "material.solder_paste", "stage": "stage.print_stroke",
         ...
         "signature": "avdp:down,aadp:down,ahdp:down",
         "signature_text": "整板三指标同时↓↓",
         "typical_spatial": ["spatial.board_wide"],
